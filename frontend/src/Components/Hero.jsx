                ...
                <div className='h-52 md:min-h-130 flex w-full md:w-1/2 flex-col justify-center items-center'>
                    <div className='leading-[30px] px-12 text-sm'>
                        <div className='flex items-center gap-2'>
                            ...
                            <p className='text-lg md:text-3xl'>HOT PICKS</p>
                        </div>
                        <h3 className='text-lg md:text-4xl text-gray-700'>New Summer Collection</h3>
                        <div className='flex items-center gap-2'>
                            <p className=' text-lg mt-1 md:text-3xl'>SHOP NOW </p>
                            <p className='w-8 md:w-11 h-[2px] bg-gray-700'></p>
                        </div>
                    </div>
                </div>
